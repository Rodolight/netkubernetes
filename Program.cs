...
// Configuar el esquema de la base de datos y accesos al token
var jwtKey = builder.Configuration.GetSection("Jwt");
 builder.Services.Configure<IConfiguration>(jwtKey);
