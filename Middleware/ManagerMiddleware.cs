...
public class ManagerMiddleware
{
    ...
    public async Task Invoke(HttpContext context){
        ...
        catch (Exception ex)
        {
            ...
            await ManageExceptionAsync(context, ex, _logger);
        }
    }

    private async Task ManageExceptionAsync(HttpContext context, Exception ex, ILogger<ManagerMiddleware> logger){
